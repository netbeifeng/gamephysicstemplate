...
int main(int argc, char* argv[])
{
	...
	simulator.setDampingFactor(0.0f);
	simulator.setStiffness(40.0f);
	simulator.applyExternalForce(Vec3(0, 0, 0));
	int p0 = simulator.addMassPoint(Vec3(0.0, 0.0f, 0), Vec3(-1.0, 0.0f, 0), false);
	int p1 = simulator.addMassPoint(Vec3(0.0, 2.0f, 0), Vec3(1.0, 0.0f, 0), false);
	simulator.addSpring(p0, p1, 1.0);
